...
document.addEventListener('DOMContentLoaded', async function() {
  ...
  async function fetchFeaturedProjects() {
    try {
      const response = await fetch('/RIGNITC/src/data/projects/featured-projects.json');
  ...
  async function fetchAllProjects() {
    try {
      const response = await fetch('/RIGNITC/src/data/projects/projects.json');
    ...
    sortedProjects.forEach(project => {
      ...
      projectCard.innerHTML = `
        <div class="project-image">
          <img
            src="/RIGNITC/assets/images/projects/${defaultImage}"
            alt="${project.title}"
            class="default-img"
            loading="lazy"
          />
          <img
            src="/RIGNITC/assets/images/projects/${hoverImage}"
