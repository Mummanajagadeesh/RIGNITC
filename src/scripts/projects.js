(async function () {
    ...
    function createCard(project, side) {
      ...
      <div class="media" aria-hidden="true">
        <img loading="lazy" src="/RIGNITC/assets/images/projects/${encodeURIComponent(project.image || 'placeholder-1.jpg')}" alt="${escapeHtml(project.title || '')}">
      </div>
      <div class="info">
    ...
    async function fetchProjects() {
        try {
            const r = await fetch('/RIGNITC/src/data/projects/projects.json', { cache: 'no-cache' });
